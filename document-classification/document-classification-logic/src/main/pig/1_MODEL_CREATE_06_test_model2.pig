...
DEFINE posNeg pl.edu.icm.coansys.classification.documents.pig.proceeders.POS();
-- -----------------------------------------------------
-- -----------------------------------------------------
-- code section
-- -----------------------------------------------------
...
Ax = distinct A;
B = group Ax by keyA;
C = foreach B generate keyA, POS(*) as (categsA:bag{(categA)}, categsQ:bag{(categQ,pos)});
