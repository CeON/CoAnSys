...
import pl.edu.icm.coansys.importers.models.DocumentProtos.{Author, DocumentMetadata}
...
class DocumentMetadataWrapperTest {
  ...
  def noAuthorsTest() {
    val meta = DocumentMetadata.newBuilder().setKey("1").build()
  ...
  def emptyAuthorTest() {
    ...
    val meta = DocumentMetadata.newBuilder().setKey("1").addAuthor(author).build()
  ...
  def abbreviationsTest() {
    ...
    val meta = DocumentMetadata.newBuilder().setKey("1").addAuthor(author1).addAuthor(author2).build()
