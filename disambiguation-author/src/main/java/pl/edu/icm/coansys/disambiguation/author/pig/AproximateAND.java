...
public class AproximateAND extends EvalFunc<DataBag> {
    ...
    public AproximateAND(String threshold, String featureDescription, String rememberSim, String printStatistics) {
        ...
        for (FeatureInfo fi : FIwithEmpties) {
            ...
            if (d == null) {
                ...
                throw new IllegalArgumentException("Cannot create disambugiator from given feature info.");
            }
            ...
            if (fi.getMaxValue() == 0) {
                ...
                throw new IllegalArgumentException("Incorrect max value for feature: " + fi.getFeatureExtractorName() + ". Max value cannot equal 0.");
            }
    ...
    /**
     * @param Tuple with bag: {(contribId:chararray, sname:chararray or int,
