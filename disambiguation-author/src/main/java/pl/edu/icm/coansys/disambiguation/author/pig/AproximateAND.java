...
public class AproximateAND extends EvalFunc<DataBag> {
	...
	public AproximateAND( String threshold, String featureDescription, String rememberSim ){
        ...
        timer = new TimerSyso("logs/aproximate.stat");
        (new Thread( timer )).start();
        //timer.addMonit("alg", "id","contribs","clusters","calculated sims","max cluster size","time");
        //timer.addMonit("apr", "S:", "=suma(B3:B1000000)", "=suma(C3:C1000000)", "=suma(D3:D1000000)","=suma(E3:E1000000)");
	}
	...
	public DataBag exec( Tuple input ) throws IOException {
		...
		try {
	        ...
	        timer.stop( "APR", timerPlayId, N, finalClusterNumber, 
	        		calculatedSimCounter, Collections.max( clustersSizes ) );
