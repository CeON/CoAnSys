...
public class FeatureInfo {
	...
	/**
	 * @param disambiguatorName a string corresponding to classes from the package "pl.edu.icm.coansys.disambiguation.author.model.feature.disambiguator".
	 * @param featureExtractorName a string corresponding to classes from the package "pl.edu.icm.coansys.disambiguation.author.model.feature.extractor".
