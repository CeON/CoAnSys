 ...
 * <ol>
 * <li>the character is compatibility decomposed,</li>
 * <li>all the combining marks are removed,</li>
 * <li>the character is compatibility composed,</li>
 * <li>additional "manual" substitutions are applied.</li>
 * </ol>
 * </p>
 * 
 * <p>
...
public class DiacriticsRemover {
	...
	private static int[] INTERESTING_TYPES = new int[] {
     ...
     *             removal or {@link #alphaSortable(String, boolean)} for sort
     *             key generation.
     * 
     * @param text
     *            Text to process.
     * @param escapeNonSpacingMarks
     *            If <code>true</code> then the result of
     *            <code>alphaSortable(text, false)</code> is returned, otherwise
     *            the result of <code>removeDiacritics(text)</code> is returned.
     * @return
     */
    @Deprecated
     ...
     * where only basic Latin characters are reliably sorted (for example,
     * a RDBMS with unknown collation settings).
     * 
     * @param text
     *            Text to process.
     * @param idempotent
     *            Whether the conversion should be idempotent. This is guaranteed to be true:
