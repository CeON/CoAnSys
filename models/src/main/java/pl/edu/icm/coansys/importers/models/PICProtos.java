...
public final class PICProtos {
  ...
  public interface PicOutOrBuilder
    ...
    // repeated .pl.edu.icm.coansys.importers.hbaseRest.model_toy.Reference refs = 2;
    java.util.List<pl.edu.icm.coansys.importers.models.PICProtos.Reference> 
        getRefsList();
    pl.edu.icm.coansys.importers.models.PICProtos.Reference getRefs(int index);
    int getRefsCount();
    java.util.List<? extends pl.edu.icm.coansys.importers.models.PICProtos.ReferenceOrBuilder> 
        getRefsOrBuilderList();
    pl.edu.icm.coansys.importers.models.PICProtos.ReferenceOrBuilder getRefsOrBuilder(
        int index);
  ...
  public static final class PicOut extends
    ...
    private java.util.List<pl.edu.icm.coansys.importers.models.PICProtos.Reference> refs_;
    public java.util.List<pl.edu.icm.coansys.importers.models.PICProtos.Reference> getRefsList() {
      return refs_;
    }
    public java.util.List<? extends pl.edu.icm.coansys.importers.models.PICProtos.ReferenceOrBuilder> 
        getRefsOrBuilderList() {
      return refs_;
    }
    ...
    public pl.edu.icm.coansys.importers.models.PICProtos.Reference getRefs(int index) {
      return refs_.get(index);
    }
    public pl.edu.icm.coansys.importers.models.PICProtos.ReferenceOrBuilder getRefsOrBuilder(
        int index) {
      return refs_.get(index);
    }
      ...
      public Builder mergeFrom(
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 18: {
              pl.edu.icm.coansys.importers.models.PICProtos.Reference.Builder subBuilder = pl.edu.icm.coansys.importers.models.PICProtos.Reference.newBuilder();
  ...
  bitField0_ |= 0x00000001;
      ...
      private void ensureRefsIsMutable() {
        if (!((bitField0_ & 0x00000002) == 0x00000002)) {
          refs_ = new java.util.ArrayList<pl.edu.icm.coansys.importers.models.PICProtos.Reference>(refs_);
          bitField0_ |= 0x00000002;
         }
      }
      
      private com.google.protobuf.RepeatedFieldBuilder<
          pl.edu.icm.coansys.importers.models.PICProtos.Reference, pl.edu.icm.coansys.importers.models.PICProtos.Reference.Builder, pl.edu.icm.coansys.importers.models.PICProtos.ReferenceOrBuilder> refsBuilder_;
      ...
      public Builder setRefs(
          int index, pl.edu.icm.coansys.importers.models.PICProtos.Reference value) {
        if (refsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setRefs(
          int index, pl.edu.icm.coansys.importers.models.PICProtos.Reference.Builder builderForValue) {
        if (refsBuilder_ == null) {
          ensureRefsIsMutable();
      ...
      public Builder addRefs(pl.edu.icm.coansys.importers.models.PICProtos.Reference value) {
        if (refsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addRefs(
          pl.edu.icm.coansys.importers.models.PICProtos.Reference.Builder builderForValue) {
        if (refsBuilder_ == null) {
          ensureRefsIsMutable();
      ...
      public Builder addAllRefs(
          java.lang.Iterable<? extends pl.edu.icm.coansys.importers.models.PICProtos.Reference> values) {
        if (refsBuilder_ == null) {
          ensureRefsIsMutable();
      ...
      public pl.edu.icm.coansys.importers.models.PICProtos.Reference.Builder getRefsBuilder(
          int index) {
      ...
      public pl.edu.icm.coansys.importers.models.PICProtos.Reference.Builder addRefsBuilder() {
        return getRefsFieldBuilder().addBuilder(
            pl.edu.icm.coansys.importers.models.PICProtos.Reference.getDefaultInstance());
      }
      public pl.edu.icm.coansys.importers.models.PICProtos.Reference.Builder addRefsBuilder(
          int index) {
        return getRefsFieldBuilder().addBuilder(
            index, pl.edu.icm.coansys.importers.models.PICProtos.Reference.getDefaultInstance());
      }
      public java.util.List<pl.edu.icm.coansys.importers.models.PICProtos.Reference.Builder> 
           getRefsBuilderList() {
        return getRefsFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          pl.edu.icm.coansys.importers.models.PICProtos.Reference, pl.edu.icm.coansys.importers.models.PICProtos.Reference.Builder, pl.edu.icm.coansys.importers.models.PICProtos.ReferenceOrBuilder> 
          getRefsFieldBuilder() {
        if (refsBuilder_ == null) {
  ...
  public static final class Reference extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return pl.edu.icm.coansys.importers.models.PICProtos.internal_static_pl_edu_icm_coansys_importers_hbaseRest_model_toy_Reference_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return pl.edu.icm.coansys.importers.models.PICProtos.internal_static_pl_edu_icm_coansys_importers_hbaseRest_model_toy_Reference_fieldAccessorTable;
    }
    ...
    public static pl.edu.icm.coansys.importers.models.PICProtos.Reference parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static pl.edu.icm.coansys.importers.models.PICProtos.Reference parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static pl.edu.icm.coansys.importers.models.PICProtos.Reference parseFrom(
    ...
    public static pl.edu.icm.coansys.importers.models.PICProtos.Reference parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static pl.edu.icm.coansys.importers.models.PICProtos.Reference parseFrom(
    ...
    public static pl.edu.icm.coansys.importers.models.PICProtos.Reference parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static pl.edu.icm.coansys.importers.models.PICProtos.Reference parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(pl.edu.icm.coansys.importers.models.PICProtos.Reference prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder>
       implements pl.edu.icm.coansys.importers.models.PICProtos.ReferenceOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return pl.edu.icm.coansys.importers.models.PICProtos.internal_static_pl_edu_icm_coansys_importers_hbaseRest_model_toy_Reference_descriptor;
      }
      ...
      // Construct using pl.edu.icm.coansys.importers.models.PICProtos.Reference.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
          getDescriptorForType() {
        return pl.edu.icm.coansys.importers.models.PICProtos.Reference.getDescriptor();
      }
      
      public pl.edu.icm.coansys.importers.models.PICProtos.Reference getDefaultInstanceForType() {
        return pl.edu.icm.coansys.importers.models.PICProtos.Reference.getDefaultInstance();
      }
      
      public pl.edu.icm.coansys.importers.models.PICProtos.Reference build() {
        pl.edu.icm.coansys.importers.models.PICProtos.Reference result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      private pl.edu.icm.coansys.importers.models.PICProtos.Reference buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        pl.edu.icm.coansys.importers.models.PICProtos.Reference result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(
      ...
      public pl.edu.icm.coansys.importers.models.PICProtos.Reference buildPartial() {
        pl.edu.icm.coansys.importers.models.PICProtos.Reference result = new pl.edu.icm.coansys.importers.models.PICProtos.Reference(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof pl.edu.icm.coansys.importers.models.PICProtos.Reference) {
          return mergeFrom((pl.edu.icm.coansys.importers.models.PICProtos.Reference)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(pl.edu.icm.coansys.importers.models.PICProtos.Reference other) {
        if (other == pl.edu.icm.coansys.importers.models.PICProtos.Reference.getDefaultInstance()) return this;
        if (other.hasRefNum()) {
  ...
  bitField0_ |= 0x00000002;
      ...
      // @@protoc_insertion_point(builder_scope:pl.edu.icm.coansys.importers.hbaseRest.model_toy.Reference)
    }
    ...
    // @@protoc_insertion_point(class_scope:pl.edu.icm.coansys.importers.hbaseRest.model_toy.Reference)
  }
  ...
  private static com.google.protobuf.Descriptors.Descriptor
    internal_static_pl_edu_icm_coansys_importers_hbaseRest_model_toy_Reference_descriptor;
  private static
    com.google.protobuf.GeneratedMessage.FieldAccessorTable
      internal_static_pl_edu_icm_coansys_importers_hbaseRest_model_toy_Reference_fieldAccessorTable;
  private static com.google.protobuf.Descriptors.Descriptor
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "rters.hbaseRest.model_toy\"\254\001\n\006PicOut\022\r\n\005" +
      "docId\030\001 \002(\t\022I\n\004refs\030\002 \003(\0132;.pl.edu.icm.c" +
      ...
      "importers.hbaseRest.model_toy.Auxiliar\"\'" +
    ...
    com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner assigner =
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_pl_edu_icm_coansys_importers_hbaseRest_model_toy_Reference_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_pl_edu_icm_coansys_importers_hbaseRest_model_toy_Reference_descriptor,
              new java.lang.String[] { "RefNum", "DocId", "Auxs", },
              pl.edu.icm.coansys.importers.models.PICProtos.Reference.class,
              pl.edu.icm.coansys.importers.models.PICProtos.Reference.Builder.class);
          internal_static_pl_edu_icm_coansys_importers_hbaseRest_model_toy_Auxiliar_descriptor =
