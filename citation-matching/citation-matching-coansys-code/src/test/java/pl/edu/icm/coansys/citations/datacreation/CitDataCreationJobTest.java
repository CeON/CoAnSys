 ...
 * @author 
 */
public class CitDataCreationJobTest {
    ...
    @Test
    public void citCreationJob() throws IOException {
        
        
        // given
        
        SparkJob sparkJob = createCitDataCreationJob();
    ...
    private SparkJob createCitDataCreationJob() {
        
        SparkJob sparkJob = SparkJobBuilder
                                           .create()
                                           
                                           .setAppName("CitDataCreationJob")
        
                                           .setMainClass(CitDataCreationJob.class)
