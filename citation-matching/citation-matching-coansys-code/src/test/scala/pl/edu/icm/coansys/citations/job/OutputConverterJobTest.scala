...
package pl.edu.icm.coansys.citations.job
...
class OutputConverterJobTest {
  ...
  def jobTest() {
    ...
    val results = MapReduceDriver.newMapReduceDriver(new pl.edu.icm.coansys.citations.mappers.OutputConverter, new pl.edu.icm.coansys.citations.reducers.OutputConverter)
