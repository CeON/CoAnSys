...
public final class AuditEntryProtos {
  ...
  public enum Level
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return pl.edu.icm.coansys.importers.model.AuditEntryProtos.getDescriptor().getEnumTypes().get(0);
    }
  ...
  public interface EntryOrBuilder
    ...
    boolean hasLevel();
        pl.edu.icm.coansys.importers.model.AuditEntryProtos.Level getLevel();
  ...
  public static final class Entry extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return pl.edu.icm.coansys.importers.model.AuditEntryProtos.internal_static_pl_edu_icm_coansys_logs_Entry_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return pl.edu.icm.coansys.importers.model.AuditEntryProtos.internal_static_pl_edu_icm_coansys_logs_Entry_fieldAccessorTable;
    }
    ...
    private pl.edu.icm.coansys.importers.model.AuditEntryProtos.Level level_;
    public boolean hasLevel() {
      return ((bitField0_ & 0x00000002) == 0x00000002);
    }
    public pl.edu.icm.coansys.importers.model.AuditEntryProtos.Level getLevel() {
      return level_;
    }
    ...
    private void initFields() {
      eventId_ = "";
      level_ = pl.edu.icm.coansys.importers.model.AuditEntryProtos.Level.FATAL;
      serviceId_ = "";
      eventType_ = "";
      timestamp_ = 0L;
    ...
    public static pl.edu.icm.coansys.importers.model.AuditEntryProtos.Entry parseFrom(
    ...
    public static pl.edu.icm.coansys.importers.model.AuditEntryProtos.Entry parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static pl.edu.icm.coansys.importers.model.AuditEntryProtos.Entry parseFrom(
    ...
    public static pl.edu.icm.coansys.importers.model.AuditEntryProtos.Entry parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static pl.edu.icm.coansys.importers.model.AuditEntryProtos.Entry parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static pl.edu.icm.coansys.importers.model.AuditEntryProtos.Entry parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(pl.edu.icm.coansys.importers.model.AuditEntryProtos.Entry prototype) {
    ...
    public static final class Builder extends
       ...
       implements pl.edu.icm.coansys.importers.model.AuditEntryProtos.EntryOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return  pl.edu.icm.coansys.importers.model.AuditEntryProtos.internal_static_pl_edu_icm_coansys_logs_Entry_descriptor;
      }
      ...
      // Construct using pl.edu.icm.coansys.logs.model.AuditEntryProtos.Entry.newBuilder()
      private Builder() {
      ...
      public com.google.protobuf.Descriptors.Descriptor
          getDescriptorForType() {
        return  pl.edu.icm.coansys.importers.model.AuditEntryProtos.Entry.getDescriptor();
      }
      
      public pl.edu.icm.coansys.importers.model.AuditEntryProtos.Entry getDefaultInstanceForType() {
        return  pl.edu.icm.coansys.importers.model.AuditEntryProtos.Entry.getDefaultInstance();
      }
      
      public pl.edu.icm.coansys.importers.model.AuditEntryProtos.Entry build() {
                pl.edu.icm.coansys.importers.model.AuditEntryProtos.Entry result = buildPartial();
      ...
      private pl.edu.icm.coansys.importers.model.AuditEntryProtos.Entry buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
                pl.edu.icm.coansys.importers.model.AuditEntryProtos.Entry result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public pl.edu.icm.coansys.importers.model.AuditEntryProtos.Entry buildPartial() {
                pl.edu.icm.coansys.importers.model.AuditEntryProtos.Entry result = new pl.edu.icm.coansys.importers.model.AuditEntryProtos.Entry(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof pl.edu.icm.coansys.importers.model.AuditEntryProtos.Entry) {
          return mergeFrom((pl.edu.icm.coansys.importers.model.AuditEntryProtos.Entry)other);
        } else {
      ...
      public Builder mergeFrom(pl.edu.icm.coansys.importers.model.AuditEntryProtos.Entry other) {
        if (other == pl.edu.icm.coansys.importers.model.AuditEntryProtos.Entry.getDefaultInstance()) return this;
        if (other.hasEventId()) {
          ...
          switch (tag) {
            ...
            case 16: {
              int rawValue = input.readEnum();
                        pl.edu.icm.coansys.importers.model.AuditEntryProtos.Level value = pl.edu.icm.coansys.importers.model.AuditEntryProtos.Level.valueOf(rawValue);
              if (value == null) {
  ...
  bitField0_ |= 0x00000001;
      ...
      // required .pl.edu.icm.coansys.logs.Level level = 2;
      private pl.edu.icm.coansys.importers.model.AuditEntryProtos.Level level_ = pl.edu.icm.coansys.importers.model.AuditEntryProtos.Level.FATAL;
      public boolean hasLevel() {
        return ((bitField0_ & 0x00000002) == 0x00000002);
      }
      public pl.edu.icm.coansys.importers.model.AuditEntryProtos.Level getLevel() {
      ...
      public Builder setLevel(pl.edu.icm.coansys.importers.model.AuditEntryProtos.Level value) {
        if (value == null) {
          throw new NullPointerException();
        }
        bitField0_ |= 0x00000002;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ansys.logs.modelB\020AuditEntryProtos"
    };
          ...
          internal_static_pl_edu_icm_coansys_logs_Entry_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              ...
              new java.lang.String[] { "EventId", "Level", "ServiceId", "EventType", "Timestamp", "Arg", },
                pl.edu.icm.coansys.importers.model.AuditEntryProtos.Entry.class,
                pl.edu.icm.coansys.importers.model.AuditEntryProtos.Entry.Builder.class);
          return null;
        }
      };
