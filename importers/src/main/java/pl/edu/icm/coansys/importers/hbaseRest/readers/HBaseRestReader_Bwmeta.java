...
//        try {
//            for (Result scannerResult : scanner) {
//                if(scannerResult.getValue(Bytes.toBytes(HBaseConstant.familyMetadata), 
//                		Bytes.toBytes(HBaseConstant.familyMetadataQualifierProto)) != null) {
//                    System.out.println("Scan: " + DocumentMetadata.parseFrom(scannerResult.value()));
//                }
//                else {
//                    System.out.println("Scan: " + Bytes.toString(scannerResult.value()));
//                }
