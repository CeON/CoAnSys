...
hadoop jar ${CLASS_JAR} pl.edu.icm.coansys.importers.io.writers.tsv.WrapperSequenceFileWriter_Bwmeta ${COLLECTION_ZIPS_DIR} ${COLLECTION_NAME} ${COLLECTION_SEQUENCE_FILE}
